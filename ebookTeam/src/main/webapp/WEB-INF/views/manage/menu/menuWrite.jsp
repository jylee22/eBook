				...
				<div class="content">
					<div class="container">
						...
						<div class="content-body">
							<form class="form-table" action="/manage/menu/write">
								<input type="hidden" name="menu_seq" value="${menu.menu_seq}"/>
								<table class="table">
									<tr>
										<th>메뉴 번호</th>
										<td><input type="text" name="menu_ctgr" value="${menu.menu_ctgr}" placeholder="메뉴 번호를 입력하세요." />${menu.menu_ctgr}</td>
									</tr>
									<tr>
										<th>메뉴 아이디</th>
									...
									<tr>
										<th>메뉴 이름</th>
										<td><input type="text" name="manu_name" value="${menu.menu_name}" placeholder="메뉴 이름을 입력하세요." /></td>
									</tr>
								</table>
